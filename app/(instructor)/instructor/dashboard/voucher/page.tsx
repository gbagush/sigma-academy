...
export default function VoucherPage() {
  ...
  const fetchVouchers = async () => {
    try {
      const response = await axios.get("/api/instructor/voucher");
...
const AddVoucherModal = ({
  ...
  const handleSubmit = async () => {
    ...
    try {
      const result = await axios.post("/api/instructor/voucher", {
...
const EditVoucherModal = ({
  ...
  const handleSubmit = async () => {
    ...
    try {
      await axios.put(`/api/instructor/voucher/${voucher._id}`, {
        code: voucherData.code.toUpperCase(),
        discount: parseInt(voucherData.discount),
        expirationDate: voucherData.expirationDate,
      });
...
const DeleteVoucherModal = ({
  ...
  const handleDelete = async () => {
    ...
    try {
      await axios.delete(`/api/instructor/voucher/${voucher._id}`);
      toast({
        title: "Success",
